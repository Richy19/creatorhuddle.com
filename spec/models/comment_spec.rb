...
describe Comment do
  ...
  describe "notifications" do
    ...
    it "notifies the update owner" do
      ...
      Notification.where(sender: sender, receiver: project_owner, target: comment, action: :posted).should_not be_empty
    end
    ...
    it "notifies other commenters" do
      ...
      Notification.where(sender: sender, receiver: other_commenter, target: comment, action: :also_posted).should_not be_empty
    end
